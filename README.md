...
FRANCISCO CANINDÉ FAGUNDES JERÔNIMO FILHO
...
Gerenciamento de Visitantes: Cadastro, listagem, busca por nome e remoção.

Gerenciamento de Atrações: Cadastro, listagem e remoção de brinquedos.

Regra de Negócio (Validação): Verificação de segurança que compara a altura do visitante com a altura mínima exigida pela atração.
...
Plataforma: .NET 10.0 (ou superior)

Estrutura de Dados: List para armazenamento em memória
